...
include('includes/header.php');
       $result = mysql_query('select count(id_product) as total from product where noibat = 1');
    ...
    <section class="sidebar-shop shop-pages dart-pt-20">
        <div class="container">
                ...
                <div class="row">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingTwo">
                                            <h4 class="panel-title">
                                                <a class="collapsed" href="my-pham/danh-muc/<?php echo $new_str?>-<?php echo $ds['id_cate'] ?>.html" role="button"  data-parent="#accordion" href="#collapseTwo"><?php echo $ds['name_cate'] ?></a>
                                            </h4>
                                        </div>
                                    </div>
                                    <?php } ?>
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-9 border-lft">
                        <div class="product-wrap">
                            ...
                            <?php
                                $sql = "select * from product order by thutu asc limit $start, $limit";
                            ...
                            ?><a href="my-pham/<?php echo $new_str?>-<?php echo $ds['id_product'] ?>.html">
            ...
            if ($current_page > 1 && $total_page > 1){
                 echo '<li class="next"><a href="http://localhost/nalee/my-pham/page/'.($current_page-1).'.html"><span class="fa fa-long-arrow-right"></span></a> </li>';
                 }
              ?>
            ...
            for ($i = 1; $i <= $total_page; $i++){
                ...
                if ($i == $current_page){
                    echo '<li class="active"><a href="#">'.$i.' <span class="sr-only">(current)</span></a></li>';
                      ...
                      echo   '<li><a href="http://localhost/nalee/my-pham/page/'.$i.'.html">'.$i.'.html</a></li>';
