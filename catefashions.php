...
include('cvtext.php');
$sql2 = "select * from catefs where id_catefs = $_GET[id] ";                                                           
$run2 = mysql_query($sql2);
$ds2 = mysql_fetch_array($run2);
$title = ''.$ds2['name_catefs'];
...
<?php include('menu.php'); ?>
    ...
    <div class="page_title_ctn">
        <div class="container-fluid">
            <h2><?php echo $ds2['name_catefs'] ?></h2>

            <ol class="breadcrumb">
                <li><a href="#">Trang chủ</a></li>
                <li class="active"><span><?php echo $ds2['name_catefs'] ?></span></li>
            </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-8 col-lg-9 border-lft">
                        <div class="product-wrap">
                            ...
                            <?php
                                $sql = "select * from fashion where id_catefs = $_GET[id] order by thutu asc";
                                                            
                                $run = mysql_query($sql);
                                                              
                                while ( $ds = mysql_fetch_array($run)) {
                                    $new_str = utf8tourl(utf8convert($ds['name_fashion']));
                            ?><a href="http://localhost/nalee/thoi-trang/<?php echo $new_str?>-<?php echo $ds['id_fashion'] ?>.html">
