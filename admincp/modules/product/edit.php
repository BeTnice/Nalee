...
<div class="row">
    <?php
                             ...
                             ?>  
	<form role="form" id="form" action="../admincp/modules/product/functionedit.php?id=<?php echo $ds['id_product'] ?>" enctype="multipart/form-data" method="post">
	<div class="col-md-9">
		<h3 class="page-header">Sửa Mỹ phẩm</h3>
		
			<input type="text" name="tensp" class="form-control" value="<?php echo $ds['name_product'] ?>" placeholder="Tên Mỹ phẩm" ><br>
			...
			<br>
			<input type="text" name="thutu" class="form-control" required="" placeholder="Thứ tự" value="<?php echo $ds['thutu'] ?>">
			<br>
      <br>
		 ...
		 <div class="btn-group">
		  ...
		  <br><br>
			...
			<br>	
		                          <?php $sql= "select * from images where id_product= $_GET[id]";
                                    $run = mysql_query($sql);
     ...
     <a href="index.php?xem=addcate"><butto type="button" class="btn btn-primary">Thêm Danh mục</button></a>
		...
		<div class="form-group">
                             ...
                             ?>
                                ...
                                if($ds['id_cate'] ==  $gender['id_cate']){
                                 ?>
                                    <option selected="seclected" value="<?php echo $gender['id_cate'] ?>"><?php echo $gender['name_cate'] ?></option>
                                    <?php }else{ ?>
                           ...
                           <!--   <div class="bs-example">
                                <label>Tags</label><br>
                               <input type="text" value=" <?php $sql ="Select * from tag,tag_product where tag.id_tag = tag_product.id_tag and tag_product.id_product = $_GET[id] ";
                                  $run = mysql_query($sql);
	...
	<div class="col-md-9">
		<br>
		<button name="editproduct" class="form-control btn-primary">Sửa</button><br><br>
	</div>
</form>
